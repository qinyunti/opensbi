...
carray-fdt_serial_drivers-$(CONFIG_FDT_SERIAL_WUQI) += fdt_serial_wuqi
libsbiutils-objs-$(CONFIG_FDT_SERIAL_WUQI) += serial/fdt_serial_wuqi.o
...
libsbiutils-objs-$(CONFIG_SERIAL_WUQI) += serial/wuqi-uart.o
